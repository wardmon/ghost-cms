...
11. Instances running a modified source code:  
   * MUST respect the [GNU AGPL](https://en.wikipedia.org/wiki/GNU%5FAffero%5FGeneral%5FPublic%5FLicense) by publishing their source code and stating their changes **before** they are added to the list  
